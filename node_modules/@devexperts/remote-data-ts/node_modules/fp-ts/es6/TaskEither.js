...
export var apW = function (fa) { return function (fab) {
    return pipe(fab, T.map(function (gab) { return function (ga) { return E.apW(ga)(gab); }; }), T.ap(fa));
}; };
/**
...
export var ap = function (fa) {
    return flow(T.map(function (gab) { return function (ga) { return pipe(gab, E.ap(ga)); }; }), T.ap(fa));
};
/**
