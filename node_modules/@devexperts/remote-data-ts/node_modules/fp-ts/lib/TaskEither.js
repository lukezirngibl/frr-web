...
exports.apW = function (fa) { return function (fab) {
    return function_1.pipe(fab, T.map(function (gab) { return function (ga) { return E.apW(ga)(gab); }; }), T.ap(fa));
}; };
/**
...
exports.ap = function (fa) {
    return function_1.flow(T.map(function (gab) { return function (ga) { return function_1.pipe(gab, E.ap(ga)); }; }), T.ap(fa));
};
/**
