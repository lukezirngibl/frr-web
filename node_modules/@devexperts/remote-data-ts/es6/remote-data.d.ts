...
export declare type RemoteInitial = {
    readonly _tag: 'RemoteInitial';
};
export declare type RemotePending = {
    readonly _tag: 'RemotePending';
    readonly progress: Option<RemoteProgress>;
};
export declare type RemoteFailure<E> = {
    readonly _tag: 'RemoteFailure';
    readonly error: E;
};
export declare type RemoteSuccess<A> = {
 ...
 *
 */
export declare type RemoteData<E, A> = RemoteInitial | RemotePending | RemoteFailure<E> | RemoteSuccess<A>;
export declare const failure: <E>(error: E) => RemoteData<E, never>;
