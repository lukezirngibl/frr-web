...
exports.Form = function (props) {
    ...
    var renderFormFieldInput = function (field) {
        ...
        if (field.type === types_1.FormFieldType.Dropdown) {
            ...
            return (react_1.default.createElement(Dropdown_1.Dropdown, __assign({}, fieldProps, { value: lens_11.get(data), onChange: function (value) { return onChange(lens_11.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.DropdownNumber) {
            var lens_12 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(DropdownNumber_1.DropdownNumber, __assign({}, fieldProps, { value: lens_12.get(data), onChange: function (value) { return onChange(lens_12.set(value)(data)); }, error: hasError })));
        }
