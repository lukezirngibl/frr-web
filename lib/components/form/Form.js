...
exports.Form = function (props) {
    ...
    var renderFormFieldInput = function (field) {
        ...
        if (field.type === types_1.FormFieldType.InputWithDropdown) {
            ...
            return (react_1.default.createElement(InputWithDropdown_1.InputWithDropdown, __assign({}, fieldProps, { value: lens_9.get(data), onChange: function (value) { return onChange(lens_9.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.Dropdown) {
            var lens_10 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(Dropdown_1.Dropdown, __assign({}, fieldProps, { value: lens_10.get(data), onChange: function (value) { return onChange(lens_10.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.DropdownNumber) {
            var lens_11 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(DropdownNumber_1.DropdownNumber, __assign({}, fieldProps, { value: lens_11.get(data), onChange: function (value) { return onChange(lens_11.set(value)(data)); }, error: hasError })));
        }
