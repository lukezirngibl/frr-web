...
exports.Form = function (props) {
    ...
    var renderFormFieldInput = function (field) {
        ...
        if (field.type === types_1.FormFieldType.NumberInput) {
            ...
            return (react_1.default.createElement(NumberInput_1.NumberInput, __assign({}, fieldProps, { value: lens_6.get(data), onChange: function (value) { return onChange(lens_6.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.TextNumber) {
            var lens_7 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(TextNumberInput_1.TextNumberInput, __assign({}, fieldProps, { value: lens_7.get(data), onChange: function (value) { return onChange(lens_7.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.InputWithDropdown) {
            var lens_8 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(InputWithDropdown_1.InputWithDropdown, __assign({}, fieldProps, { value: lens_8.get(data), onChange: function (value) { return onChange(lens_8.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.Dropdown) {
            var lens_9 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(Dropdown_1.Dropdown, __assign({}, fieldProps, { value: lens_9.get(data), onChange: function (value) { return onChange(lens_9.set(value)(data)); }, error: hasError })));
        }
        if (field.type === types_1.FormFieldType.DropdownNumber) {
            var lens_10 = field.lens, fieldProps = __rest(field, ["lens"]);
            return (react_1.default.createElement(DropdownNumber_1.DropdownNumber, __assign({}, fieldProps, { value: lens_10.get(data), onChange: function (value) { return onChange(lens_10.set(value)(data)); }, error: hasError })));
        }
