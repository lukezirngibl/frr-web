...
var getValue = function (v) { return (isNaN(Number(v)) ? 0 : Number(v)); };
exports.TextNumberInput = function (props) {
    var inputType = props.inputType, label = props.label, value = props.value, otherProps = __rest(props, ["inputType", "label", "value"]);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(semantic_ui_react_1.Input, __assign({}, otherProps, { onChange: function (e, _a) {
                ...
                setInternalValue(value);
                onChange(value);
            }, value: internalValue, type: inputType }))));
};
//# sourceMappingURL=TextNumberInput.js.map