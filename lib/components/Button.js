...
exports.Button = function (props) {
    ...
    return (react_1.default.createElement(ButtonWrapper, { onClick: disabled || props.loading ? undefined : props.onClick, style: __assign(__assign(__assign(__assign({}, getStyle('common')), getStyle(mapTypeToStyleKey[type])), (disabled ? { opacity: 0.4, pointerEvents: 'none' } : {})), (props.override || {})) },
        ...
        props.loading && (react_1.default.createElement(Loading_1.Loading, { style: {
                transform: 'scale(0.3)',
                marginRight: -24,
                marginTop: -12,
                marginLeft: 12,
