...
exports.Button = function (props) {
    ...
    return (react_1.default.createElement(ButtonWrapper, { onClick: disabled ? undefined : props.onClick, style: __assign(__assign(__assign(__assign({}, getStyle('common')), getStyle(mapTypeToStyleKey[type])), (disabled ? { opacity: 0.4, pointerEvents: 'none' } : {})), (props.override || {})) }, translate(props.label)));
};
